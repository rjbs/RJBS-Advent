...
host on L<GitHub|http://github.com/>.  If you checked, you'll see that I have a
...
all your remote repositories and checks whether you have a matching directory
in F<cwd>.  If you don't, the repository is cloned.  If you do, its origin is
fetched and the master branch is merged.  It also tells you if you have
directories lying around that don't correspond to remote repositories.
