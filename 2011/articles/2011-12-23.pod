...
going to need a C<Location> header.  C<BoringText> can be brought into let any
...
applications full gamut of exception behavior, and that you might need any
possible intersection of those.  Just I<naming> them all would be a pain.
Then you'd have to remember those names, or at least the rule you used to name
them.  Then you'd have to generate all that code and put it into files.  Then
you'd have to make sure all the classes were loaded.  I<What a drag!>
