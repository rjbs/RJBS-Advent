...
I'm using L<Pod::Simple::XHTML> to convert from Pod to HTML.  Actually, I'm
using L<Pod::Simple::XHTML::WithXHTMLRegions>, which is a subclass I wrote for
the calendar.  I'd started with L<Pod::Xhtml>, but it was buggy and
unmaintained.  Pod::Simple, on the other hand, is buggy and maintained.  Or, at
least, it's maintained.  It can be hard to tell whether it's buggy or just
incomprehensible.  Anyway, I can have a C<=begin xhtml> block that lets me
provide literal XHTML rather than Pod.  This is perfect for providing marked
up, colorized code blocks.  All I had to do was get those XHTML blocks produced
before Pod::Simple::XHTML did its thing.
...
* [Pod::Simple] - the most commonly-used Pod parser
