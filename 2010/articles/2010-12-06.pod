...
would write a Gopher server, which meant reading [the Gopher
...
interactive tn3270 session.  I must admit to being moved by feelings of
nostalgia like that -- like finding "troff" as a top-level MIME-type-like
